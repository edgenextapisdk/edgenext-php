<?php
namespace edgenextapisdk\HttpClients;
...
class HttpClientsFactory
{
     ...
     * @throws InvalidArgumentException If the http client handler isn't "curl", "stream", "guzzle", or an instance of edgenextapisdk\HttpClients\HttpClientInterface.
     *
