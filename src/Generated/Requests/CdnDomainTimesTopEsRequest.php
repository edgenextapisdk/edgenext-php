...
class CdnDomainTimesTopEsRequest extends BaseRequest
{
    public function __construct()
    {
        parent::__construct("cdn_domain_times_top_es", "POST");
    }
    ...
    public function setTopSize($value)
    {
        return $this->withBody("top_size", $value);
    }
    ...
    {
        return $this->withBody("http_referer", $value);
    }
}
