...
class TjkdPlusForwardRuleSavePlusForwardRuleRequest extends BaseRequest
{
    public function __construct()
    {
        parent::__construct("TjkdPlusForwardRule_savePlusForwardRule", "POST");
    }
    ...
    public function setSourcePort($value)
    {
        return $this->withBody("source_port", $value);
    }
    ...
    {
        return $this->withBody("actions", $value);
    }
